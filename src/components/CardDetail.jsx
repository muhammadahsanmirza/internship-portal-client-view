...
function CardDetail({ card, onClose }) {
  return (
    <div className="flex flex-col mx-4 mt-4 bg-white px-4 shadow-lg h-screen " style={{ width: '50rem' }}>
      ...
      <div className="flex justify-between items-center p-4 border-t mt-auto fixed bottom-0 bg-white mt-4">
        <div className="flex items-center">
