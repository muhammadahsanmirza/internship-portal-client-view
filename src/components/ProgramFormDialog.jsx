...
const ProgramFormDialog = ({
  ...
  const [isDeleteCoordinator, setIsDeleteCoordinator] = useState(false);
  ...
  return (
    <>
                  ...
                  <div>
                    ...
                    {coordinators?.map((coordinator) => (
                      <Chip
                        ...
                        color="info"
                        onDelete={() =>{
                          setCoordinatorId(coordinator.user_id)
                          setIsDeleteCoordinator(true)
                        } 
                        }
                        style={{ margin: "0.2em" }}
                      />
      ...
      {isDeleteCoordinator && (
        <DeleteDialog
          title={"Coordinator"}
          open={isDeleteCoordinator}
          noCallback={handleConfirmDelete}
          yesCallback={() => handleDeleteCoordinator(coordinatorId)}
        />
      )}
    </>
  );
