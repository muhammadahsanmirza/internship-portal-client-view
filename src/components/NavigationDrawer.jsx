            ...
            <div className="flex flex-col h-full">
                <div className="flex flex-row p-1 border-b-2">
                    <div className="flex flex-col flex-grow h-14 justify-center">
                        <h2 className="font-bold text-center sm:text-left text-sm sm:text-base">College of Engineering</h2>
                        <h2 className="font-bold text-center sm:text-left text-sm sm:text-base">Internship</h2>
                    </div>
                ...
                <div className="flex-grow">
                    <div className="flex flex-col justify-between mt-1">
                        <div className="flex flex-col sm:flex-row sm:items-center py-2 rounded-3xl justify-center sm:justify-start w-full hover:bg-slate-500">
                            ...
                            <button className="mx-4 text-center sm:text-left">Opportunities</button>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center py-2 rounded-3xl justify-center sm:justify-start w-full hover:bg-slate-500">
                            <CgProfile className="mx-4" />
                            <button className="mx-4 text-center sm:text-left">Profile</button>
                        </div>
                    </div>
                </div>
